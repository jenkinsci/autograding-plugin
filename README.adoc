...
image:https://badges.gitter.im/jenkinsci/warnings-plugin.svg[Join the Gitter chat, https://gitter.im/jenkinsci/warnings-plugin]
image:https://img.shields.io/github/release/jenkinsci/autograding-plugin.svg?label=changelog[changelog, link=https://github.com/jenkinsci/autograding-plugin/releases/latest]
